      ...
      <div className="grid auto-rows-[210px] grid-cols-3 gap-4">
        <div className="shadow row-span-2 rounded-xl border-2 border-slate-400/10 bg-neutral-100 p-8 col-span-1">
          <article className="flex flex-col gap-2 h-full justify-between">
            <div>
              ...
              <p className="text-lg">
                Creo tiendas en línea personalizadas para vender tus productos y
        ...
        <div className="shadow row-span-2 rounded-xl border-2 border-slate-400/10 bg-neutral-100 p-8 col-span-1">
          <article className="flex flex-col gap-2 justify-between h-full">
            <div>
              ...
              <p className="text-lg">
                Optimizo tu sitio web para que aparezca en los primeros
                resultados de búsqueda y atraiga más tráfico orgánico.
              </p>
            </div>
            <figure>
        ...
        <div className="shadow row-span-2 rounded-xl border-2 border-slate-400/10 bg-neutral-100 p-8 col-span-1">
          <article className="flex flex-col h-full gap-10 justify-between">
            <div>
              ...
              <p>
                Diseño y desarrollo de aplicaciones web intuitivas y fáciles de
                usar que potencien tu negocio.
              </p>
            </div>
            <figure>
        ...
        <div className="shadow row-span-2 rounded-xl border-2 border-slate-400/10 bg-neutral-100 p-8 col-span-1">
          <article className="flex flex-col h-full gap-10 justify-between">
            <div>
              ...
              <p>
                Creo sitios web personalizados que se ajustan a tus necesidades
                y reflejan la esencia de tu marca o proyecto.
              </p>
            </div>
            <figure>
              {/* <Image fill src="/images/freelance/responsive-design.png" alt="responsive" /> */}
        ...
        <div className="shadow row-span-2 rounded-xl border-2 border-slate-400/10 bg-neutral-100 p-8 col-span-1">
          <article className="flex flex-col h-full gap-10 justify-between">
            <div>
              ...
              <p>
                Creo aplicaciones móviles nativas y multiplataforma que te
                ayudan a llegar a una audiencia más amplia.
              </p>
            </div>
            <figure>
              {/* <Image fill src="/images/freelance/responsive-design.png" alt="responsive" /> */}
        ...
        <div className="shadow row-span-1 rounded-xl border-2 border-slate-400/10 bg-neutral-100 p-8 col-span-1">
          <article className="text-center flex flex-col gap-3">
            ...
            <p>
              ¡Hablemos! Envíame un mensaje para discutir tu proyecto y obtener
              un presupuesto personalizado. Estoy aquí para hacer que tu
              presencia en línea sea un éxito.
            </p>
          </article>
        </div>
      </div>
