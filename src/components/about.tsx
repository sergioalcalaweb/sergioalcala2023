  ...
  return (
    ...
    >
      ...
      <p>
        ...
        , I excel in developing web applications using HTML5, CSS3, and
        JavaScript, along with frameworks such as{" "}
        <strong className="text-slate-200 font-bold">
          React JS, Vue, and Angular
        </strong>
        . With a strong focus on technical excellence, I am passionate about
        staying up-to-date with the latest trends and tools in web and mobile
        development. I am an enthusiastic collaborator with strong{" "}
        <strong className="text-slate-200 font-bold">
          communication skills
        </strong>{" "}
        and a solid{" "}
        <strong className="text-slate-200 font-bold">work ethic</strong>, always
        ready to take on new challenges to contribute to the{" "}
        <strong className="text-slate-200 font-bold">
